...

{
	...
	private:
		vector<Wire*> out;		// vector of pointers to all the wires coming from the output port
		Wire* in1;				// wire coming in to the 1st input port
		Wire* in2;              // wire coming in to the 2nd input port
